...
export const TRANSLATIONS = {
  en: {
    ...
    homeFeatureSync:    "Shared lists that sync in real time",
    homeFeatureCategories: "Auto categories like Produce, Dairy, and Bakery",
    homeFeatureOffline: "Works offline and syncs when you’re back online",
  ...
  he: {
    ...
    homeFeatureSync:    "רשימות משותפות שמסתנכרנות בזמן אמת",
    homeFeatureCategories: "קטגוריות אוטומטיות כמו ירקות, חלב ומאפייה",
    homeFeatureOffline: "עובד בלי אינטרנט ומסתנכרן כשהחיבור חוזר",
